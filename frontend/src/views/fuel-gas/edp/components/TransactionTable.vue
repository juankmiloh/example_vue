    ...
    <el-row style="background:#fff;padding:16px 16px 0;margin-bottom:32px;">
      <el-collapse>
        <el-collapse-item title="Descripción del indicador" name="1">
          <b>Dispersión de precios: </b> Este indicador muestra el indice de dispersión de precios segun los grupos de mercado, modalidad, sector y fuente de los contratos, según el rango estipulado.<br>
        </el-collapse-item>
      </el-collapse>
    </el-row>
