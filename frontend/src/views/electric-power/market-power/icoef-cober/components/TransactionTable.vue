      ...
      >
        <el-collapse>
          <el-collapse-item title="Descripción del indicador" name="1">
            <b>Cobertura del índice de comparación de obligaciones en energía
              firme:
            </b>
            Este indicador ayuda a identificar los recursos de generación que
            ...
            el mercado mayorista. La cobertura es el cálculo de la OEF
            utilizando los anillos, es decir, la demanda comercial.<br>
          </el-collapse-item>
        </el-collapse>
      </el-tooltip>
    </el-row>
      ...
      import('@/vendor/Export2Excel').then((excel) => {
        if (this.data && this.data.length > 0) {
          ...
          excel.export_json_to_excel({
            ...
            data: data,
            filename:
              this.formatDate(moment()) + ' Cobertura de ' + this.indicatorName,
