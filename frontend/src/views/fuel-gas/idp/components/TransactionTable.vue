<template>
  <div class="transction-table">
    <el-row style="background:#fff;padding:16px 16px 0;margin-bottom:32px;">
      <el-collapse>
        <el-collapse-item title="Descripción del indicador" name="1">
          <b>Dispersión de precios: </b> Este indicador muestra el indice de dispersión de precios segun los grupos de mercado, modalidad, sector y fuente de los contratos.<br>
        </el-collapse-item>
      </el-collapse>
    </el-row>
    ...
    <el-table :data="data" style="width: 100%;padding-top: 15px;" class="rcorners">
      ...
      <el-table-column v-for="column in columns" :key="column.id" :label="column.name" align="center" prop="value" sortable>
        <template slot-scope="scope">
          {{ scope.row[column.id] }}
        </template>
      </el-table-column>
