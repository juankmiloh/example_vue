      ...
      >
        <el-collapse>
          <el-collapse-item title="Descripción del indicador" name="1">
            <b>Fijación de precios diario por planta: </b> Este indicador ayuda
            a identificar las plantas que fijan los precios de bolsa del mercado
            de energía mayorista y sus precios asociados .<br>
          </el-collapse-item>
        </el-collapse>
      </el-tooltip>
    </el-row>
